  ...
  <Mjml>
    ...
    <MjmlBody width={600}>
      ...
      <MjmlSection padding="0 24px" cssClass="smooth">
        <MjmlColumn>
          <Text>
            You have been invited by {hostEmail} to collaborate on his botninja{' '}
            <strong>{typebotName}</strong>.
          </Text>
          <Text>
            From now on you will see this botninja in your dashboard under his
          ...
          <Button link={url}>Go to botninja</Button>
        </MjmlColumn>
      </MjmlSection>
    </MjmlBody>
  </Mjml>
